// 공통 정렬 옵션
export const SORT_OPTIONS = ['LATEST', 'OLDEST', 'LIKES'];

// 공통 피드백 상태
export const PROCESS_STATUS = ['WAITING', 'CONFIRMED'];

// 단체 더미 uuid 목록
export const ORGANIZATION_UUIDS =
  'b624e7f3-1993-41df-975f-eb48448e18f0';
