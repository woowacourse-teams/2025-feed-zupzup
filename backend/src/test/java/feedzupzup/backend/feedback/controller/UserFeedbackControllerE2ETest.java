...
class UserFeedbackControllerE2ETest extends E2EHelper {
    ...
    void user_get_feedbacks_success() {
        ...
        given()
                ...
                .when()
                .get("/organizations/{organizationUuid}/feedbacks", organization.getUuid().toString())
                .then().log().all()
    ...
    void user_get_empty_feedbacks() {
        // given
        final String organizationUuid = UUID.randomUUID().toString(); // 피드백이 없는 장소
    ...
    void user_get_feedbacks_only_for_specific_organization() {
        ...
        given()
                ...
                .queryParam("orderBy", "LATEST")
                .when()
                .get("/organizations/{organizationUuid}/feedbacks", organization1.getUuid().toString())
                .then().log().all()
                .statusCode(HttpStatus.OK.value())
                .contentType(ContentType.JSON)
                .body("status", equalTo(200))
    ...
    void create_feedback_success() {
        ...
        given()
                ...
                .body(request)
                .when()
                .post("/organizations/{organizationUuid}/feedbacks", savedOrganization.getUuid().toString())
                .then().log().all()
    ...
    void user_create_feedback_appears_in_list() {
        ...
        given()
                ...
                .queryParam("orderBy", "LATEST")
                .when()
                .get("/organizations/{organizationUuid}/feedbacks", savedOrganization.getUuid().toString())
                .then().log().all()
                .statusCode(HttpStatus.OK.value())
                .contentType(ContentType.JSON)
                .body("status", equalTo(200))
    ...
    void user_get_statistic_success() {
        ...
        given()
                ...
                .when()
                .get("/organizations/{organizationUuid}/statistic", organization.getUuid().toString())
                .then().log().all()
                .statusCode(HttpStatus.OK.value())
                .contentType(ContentType.JSON)
                .body("status", equalTo(200))
